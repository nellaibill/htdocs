...
?>
<div class="panel-heading  text-center"><h3 class="panel-title">IT OPENING REPORT  GENERATED ON <?php echo date('d/M/Y h:i:s',strtotime( $GLOBALS ['xCurrentDate']))?>
...
while ( $row = mysql_fetch_array ( $result2 ) ) {
	...
	echo '<td>' . $row ['bankname'] . '</td>';
		echo '<td>' . $row ['accnum'] . '</td>';
			...
			echo '<td>' . $row ['it_tds'] . '</td>';
				echo '<td>' . $row ['it_interest'] . '</td>';
