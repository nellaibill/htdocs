...
xGetColumnnamename=columname;
  ...
  location.href='xupdateexpenses.php?value=' + value+ '&name=' + xGetColumnnamename + '&date=' + xDate;
...
<form action="" method="post" name="expenses">
  ...
  <?php
		...
		$xDate = "";
		$xDate = $_GET ['date'];
		$results = mysql_query ( "select * from xexpenses where date='$xDate'" );
...
<tr>
		...
		<tr>
			<td>LAB STAFF SALARY</td>
			<td><input type="text" name="passvalue" value="<?php echo $lss; ?>"
			onblur="DataUpdate(23,'lss')">
			</td>
			<td><input type="text" name="passdescription" size="50"
