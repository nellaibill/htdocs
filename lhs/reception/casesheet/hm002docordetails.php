...
<input type="text" class="form-control"  name="f_doctorname" value="<?php echo $GLOBALS ['xDoctorName']; ?>" onkeypress="return restrictCharacters(this, event, alphaOnly);" maxlength="50">
</div>

<div class="col-xs-3">
 <label>Specialist:</label>
<input type="text" class="form-control"  name="f_specialist" value="<?php echo $GLOBALS ['xSpecialist']; ?>" onkeypress="return restrictCharacters(this, event, alphaOnly);" maxlength="50">
</div>
...
<input type="text" class="form-control"  name="f_mobileno" value="<?php echo $GLOBALS ['xMobileNo']; ?>"  onkeypress="return restrictCharacters(this, event, integerOnly);" maxlength="10">
</div>
