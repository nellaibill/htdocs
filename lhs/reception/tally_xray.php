...
<b><h3 class="panel-title text-center"><?php echo "  X-RAY Records Generated FROM $xFromDate TO $xToDate As On ". date("m-d-Y h:i:sa"); ?></h3></b>
</div>
...
$xQry="SELECT date,sum(testamount) as fees from t_ecgxraybilling  WHERE date >= '$xFromDate' AND date<= '$xToDate' and testtypeno!=1 "; 
