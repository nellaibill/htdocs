...
<div id="divToPrint">
	<div class="panel panel-primary">
		<div class="panel-heading  text-center">
			<b><?php echo "Consolidated Cheque Sales Entries From[".date('d/M/y', strtotime($xFromDate))."]TO [".date('d/M/y', strtotime($xToDate))."] As On ". date("d/M/y h:i:sa"); ?></b>
...
from inv_salesentry1 as s ,account_ledger as c
where s.date >= '$xFromDate' and s.date <= '$xToDate'
and c.account_ledger_id=s.customerno and s.modeofpayment='Cheque'
group by s.customerno order by c.ledger_name";
