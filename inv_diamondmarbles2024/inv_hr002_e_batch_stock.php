...
function DataProcess($mode) {
	...
	if ($mode == 'S') {
		...
		$xQry = "UPDATE inv_stockentry   SET stock='$xStock' WHERE stockno=$xStockNo";
...
<?php
$xSlNo = 0;
//and s.stock>0  - condition removed as on 25/apr/2024 : Reason to display all the records and edit the stock 	
$xQry = "select s.itemno,s.stock,s.mrp,s.batch,s.expdate,s.stockno from inv_stockentry as s,m_item as i where i.itemno=s.itemno   order by i.itemname";
...
<td><a
	...
	echo '<tr>';
	echo '<td colspan=5>Stock Value</td>';
