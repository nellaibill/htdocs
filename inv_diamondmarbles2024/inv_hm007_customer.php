...
$xSlNo = 0;
$xTotalAmount = 0;
$xQry = "SELECT *  from account_ledger  where ledger_undergroup_no=5 order by ledger_name";
...
while ( $row = mysql_fetch_array ( $result2 ) ) {
	...
	echo '<td width=30%>' . $row ['ledger_address'] . '</td>';
	echo '<td width=30%>' . $row ['ledger_unique_no'] . '</td>';
