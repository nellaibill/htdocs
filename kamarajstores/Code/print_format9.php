...
<html>
    ...
    <body onload="window.print(); setTimeout(window.close, 0);">
        <div id="divToPrint">
            ...
            echo "<tr>
                <td  align=left width=15% ><img src=images/mrlogo.png  width=100px height=70px> </td>
		<td style='font-size: 20pt; font-family:Arial' align=center > " . $GLOBALS ['xCompanyTitle'] . " </td></tr>";
            echo "</table>";
            echo "<table width=100% > ";
            ...
            echo "<tr><td align=center style='font-size: 12pt; font-family:Arial' > GSTIN No : " . $GLOBALS ['xCompanyGSTINNo'] . " </td></tr>";
            echo "</table>";
		...
		<td width=12.5%>" . date('d/m/Y', strtotime($xBillDate)) . " </td>
            ...
            while ($row = mysql_fetch_array($result)) { // Creates a loop to loop through results
                ...
                $xAfterDiscountValue = $xUnitAmount - ($xUnitAmount * ($xDiscountPercentage / 100));
                $xGrandQty += $xQty;
                $xGrandDiscountValue += $xUnitAmount * ($xDiscountPercentage / 100);
