...
<?php
 ...
 <td><a href="print_format1.php<?php echo '?salesinvoiceno=' . $row['salesinvoiceno'] . '&xmode=report'; ?>">PRINT </a></td>
 <td><a href="print_format1D.php<?php echo '?salesinvoiceno=' . $row['salesinvoiceno'] . '&xmode=report'; ?>">PRINT </a></td>
  <td><a href="print_format2.php<?php echo '?salesinvoiceno=' . $row['salesinvoiceno'] . '&xmode=report'; ?>">PRINT </a></td>
 <td><a href="print_format2D.php<?php echo '?salesinvoiceno=' . $row['salesinvoiceno'] . '&xmode=report'; ?>">PRINT </a></td>
                                                                            <?php if($xUserRole=='A'){?>
							<td><a
