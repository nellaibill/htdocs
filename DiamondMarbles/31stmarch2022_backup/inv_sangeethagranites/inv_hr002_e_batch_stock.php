...
<?php
$xSlNo = 0;	
$xQry = "select s.itemno,s.stock,s.mrp,s.batch,s.expdate,s.stockno from inv_stockentry as s,m_item as i where i.itemno=s.itemno  and s.stock>0 order by i.itemname";
