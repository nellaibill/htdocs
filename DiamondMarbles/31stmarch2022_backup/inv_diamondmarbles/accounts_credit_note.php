...
'$xCurrentDate','$xCurrentDate','$xCurrentUser')";
		...
		$xQry = "UPDATE accounts_credit_note set 
		credit_note_date='$xcredit_note_date',
		ledger_no=$xPartyNo
	 itemno=$xItemNo,
		qty=$xReturnQty,
		details='$xReturnDetails',
		updated_as_on='$xCurrentDate',logged_user='$xCurrentUser' where accounts_credit_note_id=$xaccounts_credit_note_id";
...
<body onload='document.credit_note.f_creditnote_date.focus()'>
	...
	<div id="divToPrint">
		<div class="container">
			<div class="panel panel-info">
				...
				<div class="panel-heading  text-center">
					<b><?php echo "Sales  Return As On ". date("d/M/y h:i:sa"); ?></b>
				</div>
				<table class="table">
					<thead>
						<tr>
...
$xQry = '';
$xSlNo = 0;
$xQry = "SELECT *  from accounts_credit_note";
...
!-->
							<td><a
								href="accounts_credit_note.php<?php echo '?accounts_credit_note_id='.$row['accounts_credit_note_id'].'&qty='.$row['qty']. '&itemno='.$row['itemno']. '&xmode=delete';  ?>"
