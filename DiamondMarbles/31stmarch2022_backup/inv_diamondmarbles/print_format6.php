...
<body onload="window.print(); setTimeout(window.close, 0);">
	<div id="divToPrint">
				...
				<td  width=95% style='font-size: 30pt; font-family:Arial' align=center > " . $GLOBALS ['xCompanyTitle'] . " </td>
				...
				echo "<tr><td width=5%></td><td width=95% align=center style='font-size: 20pt; font-family:Arial' > GSTIN No : " . $GLOBALS ['xCompanyGSTINNo'] . " </td></tr>";
				echo "</table>";
		...
		echo "</table>";
				...
				<td align=left width=5%> SL  </td>
						...
						<td align=left width=30%> Particulars  </td>
												<td align=left width=15%> HSN Code  </td>
						<td align=right width=10% > Qty </td>
						<td align=right width=10% > Units </td>
				...
				while ( $row = mysql_fetch_array ( $result ) ) { // Creates a loop to loop through results
					...
					echo "<tr class=hide_bottom> 
						...
						<td align=left width=30%> " . $GLOBALS ['xItemName'] . " </td>
