...
$xQry="SELECT i.itemno,sum(i.qty) as qty,sum(i.amount)as amount from inv_salesentry as i ,m_item as m where   m.itemno=i.itemno  group by i.itemno order by m.itemname;";
