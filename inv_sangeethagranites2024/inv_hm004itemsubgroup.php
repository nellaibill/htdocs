...
<body onload='document.itemsubgroupform.f_itemsubgroupname.focus()'>
	<form class="form" name="itemsubgroupform"
		action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
		<div class="panel panel-success">
			<div class="panel panel-info">
				<div class="panel-heading  text-center">
					<h3 class="panel-title">Master Item Sub-Group</h3>
				</div>
					...
					<div class="form-group">
						<div class="col-xs-2">
							...
							<label> NO</label> <input type="text" class="form-control"
								id="f_itemsubgroupno" name="f_itemsubgroupno"
								value="<?php echo $GLOBALS ['xItemSubGroupNo']; ?>" readonly>
						</div>

						<div class="col-xs-4">

							<label>ITEM SUB GROUP NAME</label> <input type="text"
								class="form-control" name="f_itemsubgroupname"
								value="<?php echo $GLOBALS ['xItemSubGroupName']; ?>"
								placeholder="">
						</div>

						<div class="col-xs-4">

							<label>CHOOSE GROUP</label> <select class="form-control"
								name="f_itemgroupno">
		<?php
  ...
  <option value="<?php echo $row['itemgroupno']; ?>"
	...
	<div id="divToPrint">
		<div class="container">
			<div class="panel panel-success">
				<div class="panel-heading  text-center">
					<h3 class="panel-title">View Item Sub-Group</h3>
				</div>
			</div>
			<div class="panel-body">
...
while ( $row = mysql_fetch_array ( $result2 ) ) {
	...
	?>
<td><a
							href="inv_hm004itemsubgroup.php<?php echo '?itemsubgroupno='.$row['itemsubgroupno'] . '&xmode=edit'; ?>"
							onclick="return confirm_edit()"> <img src="images/edit.png"
								alt="HTML tutorial" style="width: 30px; height: 30px; border: 0">
						</a></td>
						<td><a
							href="inv_hm004itemsubgroup.php<?php echo '?itemsubgroupno='.$row['itemsubgroupno']. '&xmode=delete';  ?>"
