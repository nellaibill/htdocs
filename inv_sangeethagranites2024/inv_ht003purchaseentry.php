...
if (isset ( $_GET ['txno'] ) && ! empty ( $_GET ['txno'] )) {
	...
	$xQry = "insert into inv_purchaseentry1
	 
	(purchaseinvoiceno,supplierno,companyinvoiceno,totalamount,date,freight,others)
	values($xPurchaseInvoiceNo,$xSupplierNo,'$xCompanyInvoiceNo',$xTotalAmount,'$xDate',$xFrieght,$xOthers) ";
...
?>
				...
				<div class="col-xs-1 has-warning" style="display: none">
				...
				<div class="col-xs-2">
					<label>Gst(%):</label> <input type="text" class="form-control" readonly
						name="f_gst" id="f_gst" value="<?php echo $GLOBALS ['xVat']; ?>"
						onkeydown="javascript:if (event.which || event.keyCode){if ((event.which == 13) || (event.keyCode == 13)) {document.getElementById('additemtopurchase').click();}};"
						style="text-align: right;">
				</div>
			...
			<div class="panel-body">
				<div class="col-xs-3">
					<label>Date of Purchase</label> <input type="date"
						...
						value="<?php echo $GLOBALS ['xCurrentDate']; ?>"> <label>Supplier
...
<?php
	...
	?>
					...
					<label>Company Invoice No:</label> <input type="text"
						class="form-control" name="f_companyinvoiceno" value="0">

				</div>

				<div class="col-xs-3">
					<label>Frieght Charges</label> <input type="text"
						class="form-control" name="f_frieght" id="f_frieght" value="0"> <label>Other
						Charges:</label> <input type="text" class="form-control"
						name="f_others" id="f_others" value="0"> <label>Total Amount:</label>
					<input type="text" class="form-control" readonly
						name="f_totalamount" id="f_totalamount"
						value="<?php echo $xGrandTotal;?>" value="0">
				</div>
				<div class="col-xs-3">
