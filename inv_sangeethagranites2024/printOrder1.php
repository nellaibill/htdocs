<table>
	<tr>
		...
		<td width="80%" align="center"><b><font size="4">BARANI DATA SOLUTIONS
			...
			0432-2584848<br>GSTIN : 33AAGCB3609RIZE</td>
...
. $xCustomerName  .' <BR>
	'.$xCustomerAddress.'<br>
		'.$xCustomerMobileNo.'
					...
					<td  width="30%" align="right"> 				Bill  No : BDS - ' . $xSalesInvoiceNo . ' <br>
			...
			<hr>
		<table width="100%" >
			<tr><td width="40%">Description</td><td width="40%" align="left">Period</td><td align="right">No.Of.Days</td><td align="right">Amount</td></tr>
			</table>
			<hr >
			<table width="100%">
						<tr><td width="40%">'.$xItemName.'</td>
					<td width="40%" align="left">'.$xParticulars.'</td>
								<td width="10%" align="right">'.$xQty.'</td><td width="10%" align="right">'.fn_RupeeFormat($xUnitAmount).'</td></tr>		
		</table>
			<br>	<table width="100%">
	<tr><td width="40%"></td><td width="40%" align="right"> CGST 9%</td><td width="10%"></td><td width="10%" align="right">'.fn_RupeeFormat($CGST).'</td></tr>	
							<tr><td></td><td align="right"> SGST 9%</td><td></td><td align="right">'.fn_RupeeFormat($SGST).'</td></tr>	
								<tr><td></td><td align="right"> ROUND OFF </td><td></td><td align="right">'.fn_RupeeFormat($xRoundOff).'</td></tr>	
			...
			<tr><td width="50%">'. ucwords(convert_digit_to_words($xTotalAmount)).' Only</td>
								...
								<tr><td align="left" width="80%" >Company & Bank Details 
										<br>Name :BARANI DATA SOLUTIONS
										<br>Bank :INDIAN BANK/CA No:904102348
										<br>Branch :K.T.C.NAGAR TIRUNELVELI
										<br>IFSC Code :IDIB000K184
