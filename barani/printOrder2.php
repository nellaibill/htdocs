...
. $xCustomerName  .' <BR>
	'.$xCustomerAddress.'<br>
		...
		Mobile No :'.$xCustomerMobileNo.'
					...
					<td  width="30%" align="right"> 				Bill  No : BDS - ' . $xSalesInvoiceNoForPrint . ' <br>
		...
		<table width="100%" >
			...
			<br>	<table width="100%">
	<tr><td width="40%"></td><td width="40%" align="right"> CGST 0%</td><td width="10%"></td><td width="10%" align="right">'.fn_RupeeFormat(0).'</td></tr>	
							<tr><td></td><td align="right"> SGST 0%</td><td></td><td align="right">'.fn_RupeeFormat(0).'</td></tr>	
							<tr><td></td><td align="right"> IGST 18%</td><td></td><td align="right">'.fn_RupeeFormat($IGST).'</td></tr>	
