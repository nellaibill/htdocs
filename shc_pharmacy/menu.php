...
<li><a href="servicebill.php">Service</a></li>
                ...
                <li><span tabindex="3">Purchase</span>
                    <ul>
						...
						<li><a href="inv_hr003_e_purchasebysupplier_item_2018.php">PurchaseByItem(2018)</a></li>
                ...
                <li><span tabindex="4">Sales</span>
                    <ul>
                        ...
                        <li><a href="inv_hr004_e_salesbycustomer_item.php">Sales By
                                Customer-Item</a></li>
								<li><a href="inv_hr004_e_salesbycustomer_item_2018.php">Sales By
                                Customer-Item(old)</a></li>
...
<li><a href="acc_rep_customer_payment.php">Pending Collection</a></li>
              ...
              <!--  <li><span tabindex="4">Estimate</span>
				...
				<?php }?>
					...
					<!-- <li><a href="inv_hr002_e_batch_stock_purchasereate.php">Batch Wise Stock(PURCHASE RATE)</a></li> !-->
					...
					<li><a href="inv_hr004_c_prescription_register.php">Prescription Register</a></li>
					   ...
					   <!--   	<li><a href="inv_hr002_c_betweendates_diff.php">Detail-Stock-Diff</a></li> 
	...
	<li><span tabindex="7">Year Wise Statement</span>
				<ul>
							<li><a href="sales_type_summary.php<?php echo '?type=OP' ?>">OP Summary</a></li>
							<li><a href="sales_type_summary.php<?php echo '?type=IP' ?>">IP Summary</a></li>
							<li><a href="sales_type_summary.php<?php echo '?type=NON-OP' ?>">NON-OP Summary</a></li>
							<li><a href="sales_type_summary.php<?php echo '?type=COURIER' ?>">COURIER Summary</a></li>
				</ul>
