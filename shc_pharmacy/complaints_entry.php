...
function fn_DataClear() {
	...
	$GLOBALS ['xCustomerNo'] = '';
	$GLOBALS ['xShift'] = '';
$GLOBALS ['xRemarks']='Bill No:           Cheque No:';
		...
		<div class="panel panel-success">
			<div class="panel panel-info">
				<div class="panel-heading  text-center">
					<h3 class="panel-title">Complaint-Entry</h3>
				</div>
...
?>
		...
		<div class="col-xs-6">
							...
							<label>Complaint Details</label> <input type="text" class="form-control"
								name="f_remarks" 
								 placeholder="">
						</div>
	...
	<option>Finished</option>
						...
						<div class="col-xs-2">
							...
							<label>Amount Status</label><select class="form-control">
    <option>Pending</option>
	<option>Finished</option>
  </select>
						</div>
						...
						<div class="col-xs-3">
<label>Service Person Name :</label> <select
				class="form-control" name="f_account_ledger_id">
<?php
$result = mysql_query ( "SELECT *  FROM account_ledger where ledger_undergroup_no=4 order by ledger_name" );
while ( $row = mysql_fetch_array ( $result ) ) {
...
?>
							...
							<label>Contact Person Details</label> <input type="text" class="form-control"
								name="f_remarks" maxlength="100"
								" placeholder="">
						</div>
