...
<html>
    ...
    <body onload="window.print(); setTimeout(window.close, 0);">
		...
		<td style='font-size: 14pt; font-family:Arial' align=center > " . $GLOBALS ['xCompanyTitle'] . " </br>" . $GLOBALS ['xCompanyAddress1'] . " </br>" . $GLOBALS ['xCompanyAddress2'] . " </br>" . $GLOBALS ['xCompanyAddress3'] . " </br>" . "GSTIN No : " . $GLOBALS ['xCompanyGSTINNo'] . "</td>
</tr>";
            echo "</table>";
            ...
            echo "<tr >
				<td align=left width=5% height = 40px align=left> SL  </td>
						...
						<td align=right width=5% > Bags </td>
  ...
  echo "<tr class=hide_bottom style='font-size: 10pt;'> 
	  ...
	  echo "<tr class=hide_bottom style='font-size: 10pt;'> 
            ...
            echo "</table>";
			         ...
			         echo "<table width=100% border=1>";
            echo "<tr class=hide_bottom><td align=left> </td><td colspan=4></td></tr>";

            echo "<tr class=hide_bottom><td width=40% > </td><td width=30% align=right> Company's Bank Details </td><td width=30% align=left> </td></tr>";
            echo "<tr class=hide_bottom><td></td><td align=left> Ac No  </td><td align=left>1149280000000115  </td></tr>";
			echo "<tr class=hide_bottom><td></td><td  align=left> Bank Name </td><td align=left> KARUR VYSYA BANK </td></tr>";
            echo "<tr class=hide_bottom><td></td><td  align=left> Branch & IFSC Code </td><td w align=left>  KOVILPATTI& KVBL0001149  </td></tr>";
