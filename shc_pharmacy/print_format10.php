...
<body onload="window.print(); setTimeout(window.close, 0);">    
	...
	<div id="divToPrint">
				...
				echo "<tr  class=hide_bottom> 
                                    <td align=center width=30%>   <img src=images/mrlogo.png
		...
		<td align=left > GSTIN No" . $GLOBALS ['xCustomerGSTINNo'] . " </td>
       		...
       		<td align=left width=10%> " . $xVehicleNo . " </td></tr>";
					...
					echo "<tr class=hide_bottom>"
                                . "<td align=left > </td>"
                                        . "<td></td>
        		<td align=left>TamilNadu Code</td>
       		<td align=left width=10%> " . $xVehicleNo . " </td></tr>";
				echo "</table>";
				...
				echo "<tr > <td align=left width=10%> S.No </td>
						<td align=left  height=60px width=40%> Product Name  </td>
...
/* 					$xDiscountPercentage = $row ['discountpercentage'];
				 ...
				 <td align=left width=10%> " . $GLOBALS ['xHSNCode'] . " </td>	
						...
						<td align=right width=5%>" . $xGst . "% </td>
                                                    	<td align=right width=5%> " . $Cgst . "</td>
						<td align=right width=10%>" . fn_RupeeFormat(round($xNetAmount)) . " </td>			
		...
		echo "<tr height=50px>
                    <td align=left colspan=7 width=100%>Amount </br>
