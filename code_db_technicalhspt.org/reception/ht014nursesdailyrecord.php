...
<div class="panel-heading">
        <h3 class="panel-title  text-center">NURSES DAILY RECORD</h3>
</div>
...
<div class="form-group">
<label for="lbltxno" class="control-label col-xs-2">NURSES REPORT</label>
<div class="col-xs-3">
<textarea class="form-control" rows="3" cols="15" name="f_address" style="float:right"></textarea>
</div>
<label for="lbltxno" class="control-label col-xs-2">REMARKS</label>
<div class="col-xs-3">
<textarea class="form-control" rows="3" cols="15" name="f_address" style="float:right"></textarea>
</div>
</div></br></br>
