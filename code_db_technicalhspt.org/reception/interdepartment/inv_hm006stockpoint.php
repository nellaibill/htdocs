...
<form class="form" name="stockpointform" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
<div class="panel panel-success">
<div class="panel panel-info">
  <div class="panel-heading  text-center"><h3 class="panel-title">Master StockPoint</h3></div>
</div>
<div class="panel-body">
     <div class="form-group">
	<label for="lbltxno" class="control-label col-xs-3">STOCK POINT NO</label>
	<div class="col-xs-4">
	<input type="text" class="form-control"  name="f_stockpointno" value="<?php echo $GLOBALS ['xStockPointNo']; ?>" readonly>
	</div>
     </div></br></br>
     <div class="form-group">
	<label for="lbltxno" class="control-label col-xs-3">STOCK POINT NAME</label>
	<div class="col-xs-4">
	<input type="text" class="form-control"  name="f_stockpointname" value="<?php echo $GLOBALS ['xStockPointName']; ?>">
	</div>
     </div></br></br>
<div class="form-group">
	<label for="lbltxno" class="control-label col-xs-3">STOCK POINT SHORT NAME</label>
	<div class="col-xs-2">
	<input type="text" class="form-control"  name="f_stockpointshortname" value="<?php echo $GLOBALS ['xStockPointShortName']; ?>" maxlength="10">
	</div>
     </div>
	</br></br>
...
<div class="panel panel-info">
  ...
  <div class="panel-heading  text-center"><h3 class="panel-title">View StockPoint</h3></div>
<table class="table">
      <thead>
        <tr>
           <th width="5%">S.NO</th>
...
?>
<td width="5%"><a href="inv_hm006stockpoint.php<?php echo '?stockpointno='.$row['stockpointno'] . '&xmode=edit'; ?>"  onclick="return confirm_edit()"> <img src="../images/edit.png" alt="HTML tutorial" style="width:30px;height:30px;border:0"></a></td>
<td width="5%"><a href="inv_hm006stockpoint.php<?php echo '?stockpointno='.$row['stockpointno']. '&xmode=delete';  ?>"  onclick="return confirm_delete()"> <img src="../images/delete.png" alt="HTML tutorial" style="width:30px;height:30px;border:0"></a></td>
<?
}
echo '</tr>'; 
}
