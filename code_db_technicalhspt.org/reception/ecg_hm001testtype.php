...
<div class="col-xs-4">
<input type="text" class="form-control"  name="f_testtypename" value="<?php echo $GLOBALS ['xTestTypeName']; ?>" placeholder="" >
</div>
</div></br></br>
...
<select class="form-control"  value="" name="f_testno" id="ebno" >
            <?php
            $result = mysql_query("SELECT *  FROM m_test order by testno");
            while($row = mysql_fetch_array($result))
           {
             ?>
...
<div class="col-xs-2">
<input type="number" class="form-control"  name="f_testamount" value="<?php echo $GLOBALS ['xTestAmount']; ?>" placeholder="" >
</div>
