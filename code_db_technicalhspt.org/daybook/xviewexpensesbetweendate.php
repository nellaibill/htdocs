...
?>
<html>
<title> V-IT -EXP B/W D </title>
<head>
<link href="bootstrap.css" rel="stylesheet">
</head><form action="" method="post">
<a href="xviewallexpenses.php" >Go Back Click Here</a>

<br>
<?php


echo '<p style="color:blue;font-size:30px;font-family:calibri ;">IT EXPENSES RECORDS SHOWING FROM  ';
echo  "$_POST[fromdate] ";
echo "TO ";
echo  "$_POST[todate] ";
echo '</p>';
...
FROM xexpenses WHERE date >= '".$_POST['fromdate']."' AND date<= '".$_POST['todate']."'
...
FROM xexpenses WHERE date >= '".$_POST['fromdate']."' AND date<= '".$_POST['todate']."'order by date ; "; 
...
while ($row = mysql_fetch_array($result2)) {
    ...
    echo '<tr>';
echo '<td><a href=xeditexpenses.php?date='.$row['date']. '>EDIT</a></td>';
	 	echo '<td><a href=xdeleteexpenses.php?date='.$row['date'].'>DELETE</a></td>';
