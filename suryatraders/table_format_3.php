...
echo "<td width=7.5% style='font-size: 11pt; font-family:Arial'><b>Weight Per Bag./Kgs</b></td>";
...
echo "<td width=7.5% style='font-size: 11pt; font-family:Arial'><b>Destination Rate</b></td>";
...
for($i = 1; $i <= 1; $i ++) {
	echo "<tr>";
	echo "<td width=22% colspan=12 align=left>.</td>";
	echo "</tr>";
}*/
$xGrandTotalWt = 0;
$xGrandTotalQty = 0;
...
$result = mysql_query ( "SELECT *  FROM bill_suryatraders_section3_new WHERE salesbillno=" . $xMaxSalesBillNo ) or die ( mysql_error () );
while ( $row = mysql_fetch_array ( $result ) ) {
	...
	echo "<td width=22%  colspan=2 style='font-size: 8pt; font-family:Arial'>$xCategoryName</td>";
	
	echo "<td width=7.5% align=center style='font-size: 8pt; font-family:Arial'>$xHsnCode</td>";
	echo "<td width=7.5% align=center style='font-size: 8pt; font-family:Arial'>$xWeightPerBag</td>";
...
echo "<td width=44% colspan=2 style='font-size: 11pt; font-family:Arial'>$xRupeeString  Only</td>";
...
echo "<tr>";
echo "<td width=40% colspan=2  align=center  style='font-size: 11pt; font-family:Arial'>HSN/SAC</td>";
...
echo "<tr>";
echo "<td width=40% colspan=2  align=center style='font-size: 11pt; font-family:Arial'>$xHsnCode</td>";
