...
echo "		<font size=3><b>
TAX INVOICE </br> SALES RETURN</b></center>";
...
while ( $row = mysql_fetch_array ( $result2 ) ) {
	...
	$xBillNo = $row ['bill_no'];
	$xBillDate = $row ['bill_date'];
	$xKgs = $row ['kgs'];
	$xUsedMaterials = $row ['used_materials'];
	$ReturnMaterials = $row ['return_materials'];

}
echo "<tr>";

echo "<td colspan=4  style='font-size: 14pt; font-family:Arial'>
<u>SALES DETAILS</u>:</BR>
Bill No	      </br>
Bill Date	  </br>
Quantity	           </br>
Used Materials </br>
...
echo "<td colspan=4  style='font-size: 14pt; font-family:Arial'></br>
".$xBillNo."</br>
".date ( "d.m.y", strtotime ( $xBillDate ) )."</br>
".$xKgs."</br>
".$xUsedMaterials."</br>
".$ReturnMaterials."	</br>
